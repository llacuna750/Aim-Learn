    ...
    <div className="App">
      ...
      <div className={`${styles.noGap}`}>
        ...
        <p className="paraGraph">
          Rule of thumb: Prefer controlled components for most cases. Use
          uncontrolled for simple/quick forms or file inputs.
        </p>
        ...
        >
          ...
          >
            ...
            <ul style={{ paddingLeft: "20px", margin: 0 }}>
              ...
              <li>
                Initialize state with <code>""</code> not <code>undefined</code>
              </li>
            </ul>
          </div>
          ...
          >
            ...
            <ul style={{ paddingLeft: "20px", margin: 0 }}>
              ...
              <li>
                Use <code>undefined</code> as initial value
              </li>
